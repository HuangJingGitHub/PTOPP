...
int main( int argc, char** argv ) {
    ...
    ros::NodeHandle n;
    ros::Rate r(1);
    ros::Publisher marker_array_pub = n.advertise<visualization_msgs::MarkerArray>("vis_marker_array", 10);
    visualization_msgs::MarkerArray marker_array;
    int obs_num = 20;
    vector<PolygonObstacle3d> obs_vec = GenerateRandomObstacles3d(obs_num, Size2f(1000, 1000), 400, 50);
