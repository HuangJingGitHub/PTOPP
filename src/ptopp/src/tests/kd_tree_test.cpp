...
PathNode* FindNearestNodeByBFS(PathNode* root, Point2f test_pt) {
...
int main() {
    ...
    for (int i = 0; i < node_num; i++) {
        ...
        node_ptr_vec[i] = new PathNode(Point2f(x, y));
    ...
    vector<PathNode*> range_search_res = test_kd_tree.RanageSearch(x_min, x_max, y_min, y_max);
